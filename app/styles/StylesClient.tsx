    ...
    <>
      ...
      <section className="pt-40 pb-12">
        <div className="mx-auto max-w-[1160px] px-6 lg:px-20">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-[44px] leading-[1.05] text-brand-primary md:text-[60px]">
            Five directions. One brand.
          </h1>
          <p className="mt-6 max-w-[620px] text-[17px] leading-[1.75] text-brand-secondary">
            Each direction below takes the same content and applies a different
            premium palette. Switch between them to compare.
          </p>
      ...
      <div className="sticky top-0 z-30 border-y border-[var(--color-border-light)] bg-white/85 backdrop-blur-[12px]">
        <div className="mx-auto max-w-[1160px] overflow-x-auto px-6 lg:px-20">
        ...
        <div className="mx-auto max-w-[1160px] px-6 lg:px-20">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div className="max-w-[680px]">
              ...
              <h2 className="mt-3 font-[family-name:var(--font-display)] text-[32px] leading-[1.1] text-brand-primary">
                {activeTheme.name}
              </h2>
            ...
            <div className="flex items-center gap-3">
              ...
              <SwatchTile
                ...
                label="Primary"
              />
              <SwatchTile color={activeTheme.colors.accent} label="Accent" />
              <SwatchTile color={activeTheme.colors.bgDark} label="Dark" />
            </div>
          </div>
        </div>
      </section>
